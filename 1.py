...
def help():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Zalo     "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+"                             "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Facebook "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" FB.COM/cc                    "+Fore.LIGHTGREEN_EX+"║\n")
...
def layer7():
    ...
    stdout.write("                   "+Fore.LIGHTGREEN_EX   +"|______|_|\___/|_| |_|     |______/_/     VIP DDOS                \n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"lion2   "+Fore.LIGHTGREEN_EX+" |"+Fore.LIGHTWHITE_EX+" DDoS Ổn Định (Basic)                 "+Fore.LIGHTGREEN_EX+"║\n")                    
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"lionsock"+Fore.LIGHTGREEN_EX+" |"+Fore.LIGHTWHITE_EX+" DDoS Ổn Định (Basic)                 "+Fore.LIGHTGREEN_EX+"║\n")
...
def title():
    stdout.write("                                                                                          \n")
    stdout.write("                   "+Fore.LIGHTWHITE_EX  +" _      _             _____                             \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"| |    (_)           |  __ \                     \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"| |     _  ___  _ __ | |  | | _____   __               \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"| |    | |/ _ \| '_ \| |  | |/ _ \ \ / /              \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"| |____| | (_) | | | | |__| |  __/\ V /              \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"|______|_|\___/|_| |_|_____/ \___| \_/  Version 1.2                 \n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Sever Discord : https://discord.gg/VGJXb9Rf  "+Fore.LIGHTGREEN_EX  +"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Copyright : cao vũ ngọc anh  (Teamfee)    "+Fore.LIGHTGREEN_EX  +" ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Zalo Contact : kh có   "+Fore.LIGHTGREEN_EX  +"                  ║\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTGREEN_EX+"╔═══"+Fore.LIGHTGREEN_EX+"[""Team"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTGREEN_EX+"NGOC ANH FREE"+Fore.CYAN+"]"+Fore.LIGHTGREEN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
